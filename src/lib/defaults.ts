...
export const defaultSiteData: SiteData = {
  ...
  hero: {
    ...
    editable: {
      ...
      bannerCenterLabel: "SailGP x {partner} Teaser",
    ...
    tenant: {
      items: [
        ...
        },
        {
          ...
          // Globe with world dots lighting up green (viewers joining live).
          broadcast: true,
        },
        {
      ...
      stages: [
        {
          ...
          current: true,
          image: { src: "/assets/images/crowd 2.webp", alt: "" },
        },
        {
          _key: "st-image",
          stage: "Image",
          ...
          image: { src: "/assets/images/Team Branding.webp", alt: "" },
        },
        {
          _key: "st-activation",
          stage: "Activation",
          ...
          image: { src: "/assets/images/paddock.webp", alt: "" },
        },
        {
          ...
          image: { src: "/assets/images/Catamaran.webp", alt: "" },
        },
        {
          _key: "st-sales",
          stage: "Sales",
          ...
          image: { src: "/assets/images/crowd 3.webp", alt: "" },
        },
      ],
    },
    editable: {
